...
var Parametrize = function (_React$Component) {
  _inherits(Parametrize, _React$Component);
  ...
  function Parametrize() {
    ...
    _classCallCheck(this, Parametrize);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Parametrize.__proto__ || Object.getPrototypeOf(Parametrize)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      experimentParameters: null
    }, _this.fetchParameters = function () {
    ...
    }, _this.renderExperiment = function () {
      var experimentParameters = _this.state.experimentParameters;
      ...
      var _this$props2 = _this.props,
          ...
          passThrough = _this$props2._passThrough;
...
var When = exports.When = function (_React$Component) {
  _inherits(When, _React$Component);
  ...
  function When() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = When.__proto__ || Object.getPrototypeOf(When)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      shouldRender: false
    }, _this.shouldRenderVariation = function () {
      var value = _this.props.value;
      var paramName = _this.context.experimentProps.on;
      if (_this.context.experimentParameters && _this.context.experimentParameters[paramName] === value) {
        _this.setState({
          shouldRender: true
        });
      }
...
var Default = exports.Default = function (_React$Component2) {
...
var ABTest = function (_React$Component) {
  _inherits(ABTest, _React$Component);
  ...
  function ABTest() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ABTest.__proto__ || Object.getPrototypeOf(ABTest)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      hasRendered: false
    }, _this.enrolledInVariation = function () {
      if (!_this.state.hasRendered) {
        _this.setState({
          hasRendered: true
        });
      }
    }, _this.renderExposedVariation = function () {
      var _this$props = _this.props,
          on = _this$props.on,
          experiment = _this$props.experiment;
      ...
      return _react2.default.createElement(
        _parametrize2.default,
        {
          ...
          params: [on],
          on: on,
          enrolledInVariation: _this.enrolledInVariation,
